...
define DATA_RULE
$(SIM)/data/data_$(data)-dim_$(dim)-seed_$(seed).RData : $(SIM)/data_$(data).R
...
define COUNT_RULE
$(SIM)/data/count_$(count)-size_$(size)-$(coda).RData : $(SIM)/count_$(count).R $(SIM)/data/$(coda).RData
...
$(SIM)/data/replacement_$(replacement)-$(coda_count).RData : $(SIM)/replacement_$(replacement).R $(SIM)/data/$(coda_count).RData
...
$(SIM)/data/evaluate_$(evaluate)-$(replacement).rds : $(SIM)/evaluate_$(evaluate).R $(SIM)/data/$(replacement).RData
